...
// post add member
exports.addMember = function(appUrl, username, role, credentials) {
...
exports.removeMember = function(appUrl, username, credentials) {
  return httpReq('/apps/' + appUrl + '/members/' + username, 'DELETE', credentials, {
    body: {
      username: username      
    }
  });
...
exports.getGitToken = function(appUrl, credentials) {
  return httpReq('/git-http/' + appUrl + '/token', 'GET', credentials);
}

exports.openDevelopMode = function(appUrl, credentials) {
  return httpReq(util.format('/apps/%s/develop', appUrl), 'POST', credentials, {
    body: {
      develop_mode: true
    }
  });
