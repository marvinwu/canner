...
exports.create = function(appUrl) {
  ...
  .then(function(_repo) {
    repo = _repo;
    return Client.getGitToken(credentials);
  })
...
// add member
exports.addMember = function(appUrl, userID, role) {
  // first authorize by netrc, no file -> ask
  return Q.when(Auth.getCredentials())
  ...
  // put to /apps/:url
  .then(function(credentials) {
    return Client.addMember(appUrl, userID, role, credentials);
  })
}

// remove member
exports.removeMember = function(appUrl, userID) {
  // first authorize by netrc, no file -> ask
  return Q.when(Auth.getCredentials())
  ...
  // put to /apps/:url
  .then(function(credentials) {
    return Client.removeMember(appUrl, userID, credentials);
  })
}
